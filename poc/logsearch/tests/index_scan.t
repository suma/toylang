...
fn fixture() -> String {
    ...
    line(r#"10.0.0.1 - - [03/Sep/2026:12:00:02 +0000] "GET /b HTTP/1.1" 404 7 "-" "curl/8.0""#, &mut s)
    line(r#"10.0.0.2 - - [03/Sep/2026:12:00:03 +0000] "POST /a HTTP/1.0" 200 12 "-" "MJ12bot/1.4""#, &mut s)
    line(r#"10.0.0.3 - - [03/Sep/2026:12:00:04 +0000] "GET /c HTTP/2.0" 301 0 "-" "curl/8.0""#, &mut s)
    line(r#"10.0.0.3 - - [03/Sep/2026:12:00:05 +0000] "GET /" 400 0 "-" "-""#, &mut s)
    line(r#"10.0.0.4 - - [03/Sep/2026:12:00:06 +0000] "-" 408 0 "-" "-""#, &mut s)
    line(r#"192.168.1.9 - - [03/Sep/2026:12:00:07 +0000] "GET /a HTTP/1.1" 200 12 "-" "curl/8.0""#, &mut s)
