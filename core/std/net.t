...
# `pub`: `poll.t` closes its descriptor and reads the status through
# these two, and a module's non-`pub` functions are its own.
pub extern fn __extern_net_close(fd: i32) -> u64 from "toylang_rt" as "toy_net_close"
...
pub extern fn __extern_net_status() -> u64 from "toylang_rt" as "toy_net_status"
