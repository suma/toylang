...
# heap_alloc inside the `with` block dispatches through the
# allocator handle on top of the JIT runtime's active stack;
# everything outside still uses the global allocator. The matching
