...
### テスト状況
- 合計 1402 テスト, 31 skipped（100% 成功率、2026-05-08 時点 — STRING-API 全 Phase + AOT-SIZEOF-COMPOUND + AOT-COMPOUND-PTR-RW + TYPE-ALIAS-QUALIFIER + OP-OVERLOAD-EQ + OP-OVERLOAD-ARITH + STRING-NOMINAL + STR-INTERP-COMPOUND (struct/tuple/nested) で計 76 件追加。compiler/e2e は 198、consistency は 50+）
