...
pub trait AstVisitor {
    ...
    fn visit_call(&mut self, fn_name: &str, args: &ExprRef) -> Result<TypeDecl, TypeCheckError>;
    ...
    fn visit_number_literal(&mut self, value: &str) -> Result<TypeDecl, TypeCheckError>;
    fn visit_string_literal(&mut self, value: &str) -> Result<TypeDecl, TypeCheckError>;
    ...
    fn visit_for(&mut self, init: &String, cond: &ExprRef, step: &ExprRef, body: &ExprRef) -> Result<TypeDecl, TypeCheckError>;
