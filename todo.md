...
### テスト状況
- 合計 1326 テスト, 31 skipped（100% 成功率、2026-05-07 時点 — DICT-CROSS-MODULE-OPTION / NUM-W-AOT-pack / #121 Phase A+B-min/B-rest / DICT-AOT-NEW Phase B+C+D / `&mut self` Stage 1 / 96残 前半 / STR-PTR-LEN / STR-LEN-O1 / VEC-collection / STDLIB-alloc-trait / REF-Stage-2 (a)(d)(e)(f) で複数 regression test 追加。compiler/e2e は 191、consistency は 30 強）
