...
# Exercises is_ok / is_err / unwrap_or end-to-end with the natural
# `Result<u64, str>` shape. interpreter / JIT (silent fallback) /
# AOT all return 152.
# Expected exit: 152 = 42 + 99 + 1 + 10.

fn main() -> u64 {
    val ok: Result<u64, str> = Result::Ok(42u64)
    val err: Result<u64, str> = Result::Err("boom")
